...
<body>
    ...
    <nav class="sidebar">
        ...
        <ul>
            ...
            <li><a href="index.php?aggiungi-pdt">Aggiungi Prodotti</a></li>
            <li><a href="index.php?categorie-admin">Categorie</a></li>
            <li><a href="index.php?ordini">Ordini</a></li>
            <li><a href="index.php?rapporti">Rapporti</a></li>
            <li><a href="index.php?clienti">Clienti</a></li>
        </ul>
    </nav>
    <div class="siteBody">
        <nav class="topBar">
